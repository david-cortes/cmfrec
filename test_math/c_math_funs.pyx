...
cdef extern from "cmfrec.h":
    void factors_closed_form(
        ...
        bint scale_lam, bint scale_bias_const, double wsum,
    ...
    void optimizeA(
        ...
        int m, int n, int k,
        size_t Xcsr_p[], int Xcsr_i[], double *Xcsr,
        double *Xfull, int ldX,
        bint full_dense, bint near_dense, bint some_full,
    ...
    void optimizeA_collective(
        ...
        bint full_dense_u, bint near_dense_u, bint some_full_u, bint NA_as_zero_U,
    ...
    int precompute_collective_explicit(
        ...
        double *U_colmeans, bint NA_as_zero_U,
        int k, int k_user, int k_item, int k_main,
        bint user_bias,
        bint nonneg,
        double lam, double *lam_unique,
        bint scale_lam, bint scale_lam_sideinfo,
        bint scale_bias_const, double scaling_biasA,
    ...
    int initialize_biases(
        ...
        bint force_calc_user_scale, bint force_calc_item_scale,
...
def py_optimizeA(
    ...
    optimizeA(
        ...
        ptr_Xfull, Xfull.shape[1], full_dense, as_near_dense, full_dense,
...
def py_optimizeA_collective(
    ...
    optimizeA_collective(
        ...
        ptr_Xcsr_p, ptr_Xcsr_i, ptr_Xcsr,
        ptr_Xfull, m if is_B else n,
        full_dense, as_near_dense_x, full_dense,
        ...
        full_dense_u, as_near_dense_u, full_dense_u, NA_as_zero_U,
