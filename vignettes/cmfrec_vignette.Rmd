...
U$zipcode <- NULL
U$age2    <- U$age^2
### Note that `cmfrec` does not standardize features
...
in [Large-scale Parallel Collaborative Filtering for the Netflix Prize](https://liuxiaofei.com.cn/blog/wp-content/uploads/2014/01/netflix_aaim08submitted.pdf)),
